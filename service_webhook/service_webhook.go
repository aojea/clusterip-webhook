...
// +kubebuilder:webhook:path=/allocate-v1-clusterip,mutating=true,failurePolicy=fail,groups="",resources=services,verbs=create;update,versions=v1,name=msvc.kb.io
...
func NewClusterIPAllocator(client client.Client) (*ClusterIPAllocator, error) {
	// TODO parametrize
	_, subnet, _ := net.ParseCIDR("10.96.0.2/24")
